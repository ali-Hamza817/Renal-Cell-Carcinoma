...
st.caption("*Model was trained on a 16‑patient subset (8 Low, 8 High) and serves as a baseline. For research use, retrain on the full cohort or adjust hyper‑parameters.*")
